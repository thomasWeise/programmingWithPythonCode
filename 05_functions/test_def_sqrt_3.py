"""Testing our third implementation of Heron's Method."""

from math import inf, isnan, nan  # some float value-checking functions

from def_sqrt_3 import sqrt  # Get our 3rd square root implementation.


def test_sqrt() -> None:
    """Test the function `sqrt` from module `def_sqrt_3`."""
