...
print(gen)  # However, the contents of gen are <generator object...>.
...
print(f"{next(gen) = }")  # Returns first element:   0
...
# We stop using the generator here, so the remaining 999'999'995
# elements are never generated.
