...
# This is our internal pytest-doctest execution script.
# It prints the pytest-doctest command and the results of pytest.
...
# Construct the pytest command for documentation testing.
command="pytest --timeout=10 --no-header --tb=short --doctest-modules $2"
